                                     ...
                                     <li class="languages"><a href="#"><img src="{{ asset('\img\logo\fontlogo.jpg') }}"
                                         ...
                                         <ul class="dropdown_languages">
                                             <li><a href="#"><img src="{{ asset('\img\logo\fontlogo.jpg') }}" alt="">
                                                     English</a></li>
                                             <li><a href="#"><img src="{{ asset('\img\logo\fontlogo2.jpg') }}" alt="">
                                                     French </a></li>
                                         </ul>
                                     </li>
                         ...
                         <div class="col-lg-9 col-md-9">
                             <div class="header_right_info">
                                 ...
                                 <div class="shopping_cart">
                                     <a href="javascript:;">
                                         <i class="fa fa-shopping-cart"></i> {{ $cart->totalQty ?? '' }}Items - ${{ number_format($cart->totalPrice) ?? '' }} <i
                                     ...
                                     <div class="mini_cart">
                                        @foreach ($cart->items as $cartItem)
                                         <div class="cart_item">
                                             ...
                                             <div class="cart_info">
                                                 <a href="#">{{ $cartItem['item']->product_name }}</a>
                                                 <span>${{ number_format($cartItem['item']->product_price) }}</span>
                                                 <span class="quantity">Qty: {{ $cartItem['quantity'] }}</span>
                                                 <span class="cart_price">= ${{ number_format($cartItem['price']) }}</span>
                                             </div>
                                             <div class="cart_remove">
                                                 <a title="Remove this item" href="cart-remove.html/{{ $cartItem['item']->product_id }}"><i
                                        ...
                                        @endforeach
                                         <div class="total_price">
                                             <span> total </span>
                                             <span class="prices"> ${{ number_format($cart->totalPrice) ?? '' }} </span>
                                         </div>
                                                 ...
                                                 <div class="mega_menu">
                                                     ...
                                                     <div class="mega_bottom fix">
                                                         <div class="mega_thumb">
                                                             <a href="#"><img
                                                                     src="{{ asset('img\banner\banner1.jpg') }}"
                                                                     alt=""></a>
                                                         </div>
                                                         <div class="mega_thumb">
                                                             <a href="#"><img
                                                                     src="{{ asset('img\banner\banner2.jpg') }}"
                                                                     alt=""></a>
                                                         </div>
                                                     </div>
                                                 </div>
                                             ...
                                             <li><a href="#">men</a>
                                                 <div class="mega_menu">
                                                     <div class="mega_top fix">
                                                         ...
                                                         <div class="mega_items">
                                                             <a href="#"><img
                                                                     src="{{ asset('img\banner\banner3.jpg') }}"
                                                                     alt=""></a>
                                                         </div>
                                                     </div>
