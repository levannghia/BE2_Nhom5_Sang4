...
<!-- bootstrap-css -->
<link rel="stylesheet" href="{{asset('/quantri/css/bootstrap.min.css')}}" >
<!-- //bootstrap-css -->
<!-- Custom CSS -->
<link href="{{asset('/quantri/css/style.css')}}" rel='stylesheet' type='text/css' />
<link href="{{asset('/quantri/css/style-responsive.css')}}" rel="stylesheet"/>
<!-- font CSS -->
<link href='//fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'>
<!-- font-awesome icons -->
<link rel="stylesheet" href="{{asset('/quantri/css/font.css')}}" type="text/css"/>
<link href="{{asset('/quantri/css/font-awesome.css')}}" rel="stylesheet"> 
<link rel="stylesheet" href="{{asset('/quantri/css/morris.css')}}" type="text/css"/>
<!-- calendar -->
<link rel="stylesheet" href="{{asset('/quantri/css/monthly.css')}}">
<!-- //calendar -->
<!-- //font-awesome icons -->
<script src="{{asset('/quantri/js/jquery2.0.3.min.js')}}"></script>
<script src="{{asset('/quantri/js/raphael-min.js')}}"></script>
<script src="{{asset('/quantri/js/morris.js')}}"></script>
</head>
<body>
...
<script src="{{asset('/quantri/js/bootstrap.js')}}"></script>
<script src="{{asset('/quantri/js/jquery.dcjqaccordion.2.7.js')}}"></script>
...
<!-- calendar -->
	<script type="text/javascript" src="{{asset('/quantri/js/monthly.js')}}"></script>
