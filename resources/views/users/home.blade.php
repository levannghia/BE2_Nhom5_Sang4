           ...
           <!--sidebar banner-->
            <div class="sidebar_widget banner mb-35">
                <div class="banner_img mb-35">
                    <a href="#"><img src="{{asset('img\banner\banner5.jpg')}}" alt=""></a>
                </div>
                <div class="banner_img">
                    <a href="#"><img src="{{asset('img\banner\banner6.jpg')}}" alt=""></a>
                </div>
            </div>
            <!--sidebar banner end-->
            ...
            <div class="sidebar_widget bottom ">
                <div class="banner_img">
                    <a href="#"><img src="{{asset('img\banner\banner9.jpg')}}" alt=""></a>
                </div>
            </div>
            <!--sidebar banner end-->
        ...
        <div class="col-lg-9 col-md-12">
            ...
            <div class="banner_slider slider_1">
                <div class="slider_active owl-carousel">
                    <div class="single_slider" style="background-image: url({{asset('img/slider/slide_1.png')}})">
                        ...
                        <div class="col-lg-3">
                            <div class="single_product">
                                <div class="product_thumb">
                                   <a href="product.html/{{ $topProduct->product_id }}"><img src="img\product\product1.jpg" alt=""></a> 
                                   <div class="img_icone">
                                       <img src="img\cart\span-new.png" alt="">
                                   </div>
                                   <div class="product_action">
                                       <a href="cart.html/{{ $topProduct->product_id }}"> <i class="fa fa-shopping-cart"></i> Add to cart</a>
                                   </div>
                                </div>
                                <div class="product_content">
                                    <span class="product_price">${{ number_format($topProduct->product_price) }}</span>
                                    <h3 class="product_title"><a href="single-product.html">{{ $topProduct->product_name }}</a></h3>
                                </div>
                                <div class="product_info">
                                    <ul>
                                        <li><a href="#" title=" Add to Wishlist ">Add to Wishlist</a></li>
                                        <li class="view-detail-product" data-url="{{ asset('product.html') }}" data-id="{{ $topProduct->product_id }}">
                ...
                <div class="row">
                    <div class="product_active owl-carousel">
                        <div class="col-lg-3">
                            <div class="single_product">
                                <div class="product_thumb">
                                   <a href="single-product.html"><img src="{{asset('img\product\product7.jpg')}}" alt=""></a> 
                                   <div class="hot_img">
                        ...
                        <div class="col-lg-3">
                            <div class="single_product">
                                <div class="product_thumb">
                                   <a href="single-product.html"><img src="{{asset('img\product\product8.jpg')}}" alt=""></a> 
                                   <div class="img_icone">
                        ...
                        <div class="col-lg-3">
                            <div class="single_product">
                                <div class="product_thumb">
                                   <a href="single-product.html"><img src="{{asset('img\product\product9.jpg')}}" alt=""></a> 
                                   <div class="img_icone">
                                       <img src="{{asset('img\cart\span-new.png')}}" alt="">
                                   </div>
                                   <div class="product_action">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="single_banner">
                            <a href="#"><img src="{{asset('img\banner\banner7.jpg')}}" alt=""></a>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single_banner">
                            <a href="#"><img src="{{asset('img\banner\banner8.jpg')}}" alt=""></a>
            ...
            <div class="brand_logo mb-60">
                ...
                <div class="row">
                    <div class="brand_active owl-carousel">
                        ...
                        <div class="col-lg-2">
                            <div class="single_brand">
                                <a href="#"><img src="{{asset('img\brand\brand6.jpg')}}" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    $('.view-detail-product').on('click', function () {
        $.ajax({
            ...
            success:function(product) {
                $("#model-product-name").text(product.product_name);
                $("#model-product-price").text(product.product_price);
                $("#model-product-description").text(product.product_description);
                $("#model-product-id").text(product.product_price);
                $('#modal_box_product_detail').modal('toggle');
            }
        });
    });
</script>
