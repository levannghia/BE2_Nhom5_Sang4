                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single_product">
                                            ...
                                            <div class="product_content">
                                                <span class="product_price">{{ number_format($item->product_price )}} VNĐ</span>
                                                <h3 class="product_title"><a href="{{url('/chi-tiet-san-pham/id='.$item->product_id)}}">{{ $item->product_name }}</a></h3>
                                            </div>
                                            ...
                                            <div class="list_product_content">
                                               <div class="product_ratting">
                                                ...
                                                <div class="list_title">
                                                    <h3><a href="{{url('/chi-tiet-san-pham/id='.$item->product_id)}}">{{ $item->product_name }}</a></h3>
                                                </div>
